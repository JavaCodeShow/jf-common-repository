...
public class StringToJsonUtils {
    ...
    public static String toJSONString(String toString) throws ParseException {
        ...
        return JSONObject.toJSONString(stringObjectMap, SerializerFeature.WriteMapNullValue);
    }
            ...
            for (int i = 0; i < token.length(); i++) {
                ...
                if (TOKEN_LEFT.contains(c)) {
                    ...
                    if (TOKEN_LEFT.indexOf(stack.peek()) != TOKEN_RIGHT.indexOf(c)) {
                        throw new RuntimeException("splitFirstToken error, stack=" + stack + ", string字符串=" + token);
                    }
