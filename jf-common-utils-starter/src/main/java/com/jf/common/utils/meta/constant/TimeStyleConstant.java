package com.jf.common.utils.meta.constant;

/**
 * 描述: 时间格式相关常量
 *
 * @author: 江峰
 * @create: 2021-03-19 17:45
 * @since: 2.20.1.1
 */
public final class TimeStyleConstant {
    ...
    public static final String FORMAT_YYYYMMDD24HHMMSSSSS = "yyyy-MM-dd HH:mm:ss.SSS";
    ...
    public static final String FORMAT_NOLINE_YYYYMMDDHHMMSS = "yyyymmddhhmmss";
